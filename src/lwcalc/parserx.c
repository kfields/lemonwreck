...
#endif
#define ParseARG_SDECL  calculator *pCalc;
#define ParseARG_PDECL , calculator *pCalc
#define ParseARG_FETCH  calculator *pCalc = yypParser->pCalc
#define ParseARG_STORE yypParser->pCalc = pCalc
#define YYNSTATE 15
#define YYNRULE 8
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    15,    3,    2,    5,    4,    3,    2,    5,    4,    3,
 /*    10 */     2,    9,   10,    8,   14,   13,    7,   24,   12,   11,
 /*    20 */     1,    6,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    5,    6,    3,    4,    5,    6,    3,    4,    5,
 /*    10 */     6,   10,    8,   10,    1,    2,   10,   11,   10,   10,
 /*    20 */     7,   10,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    23,   23,   23,   23,   23,   23,   23,   23,   19,   18,
 /*    10 */    22,   21,   20,   17,   16,
};
...
static void yy_reduce(
  ...
  */
      case 1: /* expr ::= INTEGER */
#line 35 "parserx.y"
{ yygotominor.yy0 = set_int(pCalc, yymsp[0].minor.yy0); }
#line 670 "parserx.c"
        break;
      case 2: /* expr ::= FLOAT */
#line 36 "parserx.y"
{ yygotominor.yy0 = set_float(pCalc, yymsp[0].minor.yy0); }
#line 675 "parserx.c"
        break;
...
#line 700 "parserx.c"
        break;
      default:
      /* (0) in ::= expr */ yytestcase(yyruleno==0);
        break;
  };
